...
public class Gateway1App {
    ...
    private static final Logger log = LoggerFactory.getLogger(Gateway1App.class);

    private final Environment env;

    public Gateway1App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gateway1.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Gateway1App.class);
